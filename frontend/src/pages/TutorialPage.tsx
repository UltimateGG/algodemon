  ...
  return (
    <PageStyle theme={theme}>
      <Box className="container" flexDirection="column" spacing="1.6rem">
        ...
        <p>If the indicator does not show up under "Invite Only Scripts" after 5 minutes, please join our <a href={DISCORD_URL} target="_blank" rel="noopener noreferrer">Discord</a> and message a staff member with your TradingView username and order ID.</p>
