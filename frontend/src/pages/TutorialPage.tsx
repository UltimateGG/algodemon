  ...
  return (
    <PageStyle theme={theme}>
      <Box className="container" flexDirection="column" spacing="1.6rem">
        ...
        <img className="main-img" src="https://i.imgur.com/7MdvZ5Q.png" alt={NAME + " Indicator"} style={{ maxWidth: '900px', margin: '0 auto' }} />
        ...
        <img className="energy-cloud" src="https://i.imgur.com/0YujqaS.png" alt="Energy Cloud" style={{ maxWidth: '500px' }} />



        <h2>Features / Automated Support &amp; Resistance</h2>
        ...
        <img className="energy-cloud" src="https://i.imgur.com/G1kojVJ.png" alt="Auto SR Levels" style={{ maxWidth: '500px' }} />
      </Box>
    </PageStyle>
  );
}
